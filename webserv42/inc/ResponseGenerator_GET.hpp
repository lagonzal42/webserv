...
<<<<<<< HEAD
		static std::string	getRedirResponse(const Parser::Location& currentLoc, const Parser::Server& currentServ ); //I still dont know what do i need here, i supose request is needed but idk if something else
=======
